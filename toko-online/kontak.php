...
<!-- about -->
		<div class="privacy about">
			<h3>About Us</h3>
			<p class="animi"> 
				Bagus Gusti Lambang. NPM (13.2019.1.90135) Tugas Akhir Praktikum PSI
			</p>
		...
		<div class="container">
			...
			<div class="agileits_team_grids">
				<div class="col-md-3 agileits_team_grid">
					<img src="asset/kontak/yaminbae.jpg" alt=" " class="img-responsive" />
					<h4> Abdul yamin</h4>
					<p>Programmer</p>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="asset/kontak/asri.jpg" alt=" " class="img-responsive" />
					<h4>Asri Hidayat</h4>
					<p>Pengarah</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
      ...
      <div class="agile_footer_grids">
        <div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
          <div class="w3_footer_grid_bottom">
            <h4><p>© 2016 BGL Store | Design by Bagus Gusti Lambang </p></h4>
