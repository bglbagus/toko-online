	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="#"><span>TOKO ONLINE</span> BGL Store</a></h1>
			</div>
	...
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				...
				<li> Toko Online Praktikum PSI Bagus Gusti Lambang </li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
								...
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<img src="admin/assets/images/<?php echo $data['br_gbr']; ?>" />	
											<p><?php echo $data['br_nm']; ?></p>
											<h4>Rp.<?php echo number_format($data['br_hrg'],2,",",".");?> <span>$10.00</span></h4>
										</div>
										<div class="snipcart-details top_brand_home_details">
												<fieldset>
												<a href="detailproduk.php?kd=<?php echo $data['br_id'];?>" class="btn btn-danger">Detail</a> 
												<a href="detailproduk.php?kd=<?php echo $data['br_id'];?>" class="btn btn-success">Beli &raquo;</a>
												</fieldset>
										</div>
									</div>
								</figure>
			...
			<div class="agile_footer_grids">
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						<h4><p>© 2020 BGL Store | Design by Bagus Gusti Lambang </p></h4>
